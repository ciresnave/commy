...
pub fn next_prime(n: &BigUint) -> BigUint {
    ...
    let mut moduli: Vec<BigUint> = Vec::with_capacity(prime_limit);
    for _ in 0..prime_limit {
        moduli.push(BigUint::zero());
    }
...
mod tests {
    ...
    lazy_static! {
    static ref PRIMES: Vec<&'static str> = Vec::from([
        "2",
        "3",
        "5",
        "7",
    ...
    static ref COMPOSITES: Vec<&'static str> = Vec::from([
            "0",
            "1",
        ...
        // Test Cases from #51
    static ref ISSUE_51: Vec<&'static str> = Vec::from([
            "1579751",
            "1884791",
            "3818929",
            "4080359",
    ...
    test_pseudo_primes!(
        ...
        Vec::from([989, 3239, 5777, 10877, 27971, 29681, 30739, 31631, 39059, 72389, 73919, 75077])
    );
